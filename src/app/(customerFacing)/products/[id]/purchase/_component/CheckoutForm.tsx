    ...
    return (
        <div className='max-w-5xl w-full mx-auto space-y-8'>
            ...
            <Elements options={{ clientSecret }} stripe={stripePromise}>
                ...
                <Form priceInCent={product.priceInCent} productId={product.id} />
            </Elements>
...
function Form({ priceInCent, productId }: { priceInCent: number, productId: string }) {
            ...
            <Card>
                ...
                <CardFooter>
                    <Button className='w-full' disabled={stripe == null || elements == null || isLoading}>
                        {isLoading ? "Purchasing.." : `Purchase -  ${formatCurrency(priceInCent / 100)}`}
                    </Button>
                </CardFooter>
            </Card>
